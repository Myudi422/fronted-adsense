...
export default function TodayEarningsPage() {
  ...
  const formatRPM = (rpm: number) => {
    // RPM values from API are already in proper format, just add 'rb' suffix
    return `Rp ${rpm.toFixed(1)}rb`;
  };

  const formatCPC = (cpc: number) => {
    // CPC values from API are already in proper format, just add 'rb' suffix  
    return `Rp ${cpc.toFixed(2)}rb`;
  };
      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="card">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Page CTR</h3>
                <div className="text-3xl font-bold text-blue-600">
                  {((earnings as any).page_ctr || 0).toFixed(2)}%
                </div>
                <div className="text-sm text-gray-500 mt-2">
              ...
              <div className="card">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">CPC (Cost Per Click)</h3>
                <div className="text-3xl font-bold text-emerald-600">
                  {formatCPC((earnings as any).cpc_idr || 0)}
                </div>
                <div className="text-sm text-gray-500 mt-2">
              ...
              <div className="card">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Impressions Per Page</h3>
                <div className="text-3xl font-bold text-amber-600">
                  {((earnings as any).impressions_per_page || 0).toFixed(2)}
                </div>
                <div className="text-sm text-gray-500 mt-2">
                  Average ad density per page
                </div>
              </div>

              <div className="card">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Earnings Per Page</h3>
                <div className="text-3xl font-bold text-violet-600">
                  {formatCurrency((earnings as any).earnings_per_page_idr || 0)}
                </div>
                <div className="text-sm text-gray-500 mt-2">
