                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {domainData.domains.map((domain, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                              ((domain as any).page_ctr || 0) >= 3 ? 'bg-green-100 text-green-800' :
                              ((domain as any).page_ctr || 0) >= 2 ? 'bg-yellow-100 text-yellow-800' :
                              'bg-red-100 text-red-800'
                            }`}>
                              {((domain as any).page_ctr || 0).toFixed(2)}%
                            </span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {formatCPC((domain as any).cpc_idr || 0)}
                          </td>
                        </tr>
                      ))}
                    </tbody>
